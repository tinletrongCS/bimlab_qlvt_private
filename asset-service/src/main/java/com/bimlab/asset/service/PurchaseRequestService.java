...
/**
 * Server stamps {@code requesterEmployeeId} from JWT principal on create and
 * forces {@code status=PENDING}. Approver-supplied payload cannot impersonate
 * requester or pre-approve a PR.
 */
@Service
