...
export function CrudModal({ title, subtitle, children, submitting, onClose, onSubmit }: CrudModalProps) {
  return (
    <div className="modal-backdrop" onMouseDown={onClose}>
      <form className="crud-modal" onSubmit={onSubmit} onMouseDown={(event) => event.stopPropagation()}>
